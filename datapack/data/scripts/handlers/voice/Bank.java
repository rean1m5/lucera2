...
public class Bank implements IVoicedCommandHandler {
	...
	private void showHelp(L2PcInstance cha) {
		...
		cha.sendMessage(".bank gold - для обмена "+Config.BANKING_GOLDBAR_PRICE+" на "+item.getName());
		cha.sendMessage(".bank adena - для обмена "+item.getName()+" на "+Config.BANKING_GOLDBAR_PRICE+" адена ");
