package ru.catssoftware.collections;
 ...
 * При получении элементов с помощью метода {@link java.util.List#get(int) List.get(int)}, как и при итерации, может вернуть null, в случае, если индекс выходит за пределы массива.
 * <p>
...
public class LazyArrayList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
	 ...
	 * Для получения элементов коллекции используется метод {@link java.util.Collection#toArray() Collection.toArray()}
	...
	/**
	 * Добавить все элементы коллекции в список. Для получения элементов коллекции используется метод {@link java.util.Collection#toArray() Collection.toArray()}
	...
	/**
	 * Удаляет из списка все элементы, которые не содержатся в заданной коллекции, для проверки нахождения элемента в коллекции используется метод коллекции {@link java.util.Collection#contains(Object) Collection.contains(Object)}
	...
	/**
	 * Удаляет из списка все элементы, которые содержатся в заданной коллекции, для проверки нахождения элемента в коллекции используется метод коллекции {@link java.util.Collection#contains(Object) Collection.contains(Object)}
